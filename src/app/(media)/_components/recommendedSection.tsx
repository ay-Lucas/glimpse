...
//       const res =
//         item.mediaType === "tv"
//           ? await getTvRatings(item.id)
//           : await getMovieCertifications(item.id);
//       if (!res) return;
//       return res;
//     })
//   );
...
//     } else if (rating.mediaType === "movie") {
...
//
//   const recs = rating
//     ? await getValidRecommendations(mediaType, rating, recommendations)
//     : recommendations;
//
//   return (
//     <div className="media-card">
//       <Recommended recommendations={recs} />
//     </div>
//   );
// }
