import { PersonCastCredit } from "@/types/request-types-camelcase";

export function getTopPopularCastCredits(
  limit: number,
  castCredit: PersonCastCredit[]
) {
  const prominent = castCredit.filter((c) => {
