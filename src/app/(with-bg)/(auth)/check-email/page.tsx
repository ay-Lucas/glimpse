...
export default async function CheckEmailPage({
  ...
  return (
    <div className="p-2">
      <div className="flex max-w-md flex-col space-y-3 rounded-lg bg-gray-800/75 p-8 shadow-2xl backdrop-blur">
        ...
        <p className="text-sm text-gray-500">
          It was sent{" "}
          {minutesAgo === 0 ? "just now" : `${minutesAgo} minute(s) ago`}.
        </p>
        ...
        {canResend ? (
          ...
          <p className="text-sm text-gray-400">
            You can request a new link in {COOLDOWN_MINUTES - minutesAgo}{" "}
            minute(s).
          </p>
        )}
      </div>
